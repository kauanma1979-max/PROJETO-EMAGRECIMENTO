...
const SCHEDULE_DATA: Omit<ScheduleItem, "id">[] = [
  // MÊS 1
  { dateStr: "17/07/2026", isoDate: "2026-07-17", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte superior", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  { dateStr: "24/07/2026", isoDate: "2026-07-24", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço superior, parte externa (trás do braço)", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  { dateStr: "31/07/2026", isoDate: "2026-07-31", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço superior da coxa (próximo à virilha), parte frontal", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  { dateStr: "07/08/2026", isoDate: "2026-08-07", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte média (na altura do umbigo)", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  { dateStr: "14/08/2026", isoDate: "2026-08-14", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço médio do braço, parte externa (trás do braço)", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  { dateStr: "21/08/2026", isoDate: "2026-08-21", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço médio da coxa, parte frontal", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  { dateStr: "28/08/2026", isoDate: "2026-08-28", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte inferior", monthGroup: "📅 MÊS 1: JULHO/AGOSTO 2026" },
  ...
  // MÊS 2
  { dateStr: "04/09/2026", isoDate: "2026-09-04", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço inferior (próximo ao cotovelo), parte externa (trás do braço)", monthGroup: "📅 MÊS 2: SETEMBRO 2026" },
  ...
  { dateStr: "11/09/2026", isoDate: "2026-09-11", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço inferior da coxa (próximo ao joelho), parte frontal", monthGroup: "📅 MÊS 2: SETEMBRO 2026" },
  ...
  { dateStr: "18/09/2026", isoDate: "2026-09-18", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte lateral extrema (flanco)", monthGroup: "📅 MÊS 2: SETEMBRO 2026" },
  ...
  { dateStr: "25/09/2026", isoDate: "2026-09-25", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço superior, parte interna (lado do corpo)", monthGroup: "📅 MÊS 2: SETEMBRO 2026" },
  ...
  // MÊS 3
  { dateStr: "02/10/2026", isoDate: "2026-10-02", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço superior da coxa, parte lateral (parte de fora da perna)", monthGroup: "📅 MÊS 3: OUTUBRO 2026" },
  ...
  { dateStr: "09/10/2026", isoDate: "2026-10-09", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte superior (volta)", monthGroup: "📅 MÊS 3: OUTUBRO 2026" },
  ...
  { dateStr: "16/10/2026", isoDate: "2026-10-16", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço superior, parte externa (volta)", monthGroup: "📅 MÊS 3: OUTUBRO 2026" },
  ...
  { dateStr: "23/10/2026", isoDate: "2026-10-23", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço superior, parte frontal (volta)", monthGroup: "📅 MÊS 3: OUTUBRO 2026" },
  ...
  { dateStr: "30/10/2026", isoDate: "2026-10-30", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte média (volta)", monthGroup: "📅 MÊS 3: OUTUBRO 2026" },
  ...
  { dateStr: "06/11/2026", isoDate: "2026-11-06", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço médio, parte externa (volta)", monthGroup: "📅 MÊS 4: NOVEMBRO 2026" },
  ...
  { dateStr: "13/11/2026", isoDate: "2026-11-13", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço médio, parte frontal (volta)", monthGroup: "📅 MÊS 4: NOVEMBRO 2026" },
  ...
  { dateStr: "20/11/2026", isoDate: "2026-11-20", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte inferior (volta)", monthGroup: "📅 MÊS 4: NOVEMBRO 2026" },
  ...
  { dateStr: "27/11/2026", isoDate: "2026-11-27", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço inferior, parte externa (volta)", monthGroup: "📅 MÊS 4: NOVEMBRO 2026" },
  ...
  // MÊS 5
  { dateStr: "04/12/2026", isoDate: "2026-12-04", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço inferior, parte frontal (volta)", monthGroup: "📅 MÊS 5: DEZEMBRO 2026" },
  ...
  { dateStr: "11/12/2026", isoDate: "2026-12-11", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte lateral extrema (volta)", monthGroup: "📅 MÊS 5: DEZEMBRO 2026" },
  ...
  { dateStr: "18/12/2026", isoDate: "2026-12-18", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço superior, parte interna (volta)", monthGroup: "📅 MÊS 5: DEZEMBRO 2026" },
  ...
  { dateStr: "25/12/2026", isoDate: "2026-12-25", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço superior, parte lateral (volta)", monthGroup: "📅 MÊS 5: DEZEMBRO 2026" },
  ...
  // MÊS 6
  { dateStr: "01/01/2027", isoDate: "2027-01-01", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Abdômen Esquerdo", microArea: "Lado esquerdo do umbigo, parte superior (2ª volta)", monthGroup: "📅 MÊS 6: JANEIRO 2027" },
  ...
  { dateStr: "08/01/2027", isoDate: "2027-01-08", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Braço Esquerdo", microArea: "Terço superior, parte externa (2ª volta)", monthGroup: "📅 MÊS 6: JANEIRO 2027" },
  ...
  { dateStr: "15/01/2027", isoDate: "2027-01-15", dayOfWeek: "Sexta", medication: "Tirzepatida", mainArea: "Coxa Esquerda", microArea: "Terço superior, parte frontal (2ª volta)", monthGroup: "📅 MÊS 6: JANEIRO 2027" },
...
export default function RastreadorInjecaoCard() {
  ...
  // Dosage sums (2.5 mg per completed application)
  ...
  const retatrutidaCompletedCount = SCHEDULE_DATA.filter(
    (item, idx) => item.medication === "Retatrutida" && completedIds.includes(String(idx))
  ).length;

  const tirzepatidaTotalMg = tirzepatidaCompletedCount * 2.5;
  const retatrutidaTotalMg = retatrutidaCompletedCount * 2.5;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 flex items-center justify-between relative overflow-hidden">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 font-semibold">
              {retatrutidaCompletedCount} {retatrutidaCompletedCount === 1 ? "aplicação realizada" : "aplicações realizadas"} (2,5 mg cada)
            </p>
          </div>
                    ...
                    >
                      <div className="flex items-start md:items-center gap-4 w-full md:w-auto">
                        ...
                        <button
                          ...
                          title={isCompleted ? "Marcar como pendente" : "Marcar como aplicada (+2,5 mg)"}
                        >
                      ...
                      <div className="shrink-0 self-end md:self-center">
                        <span className={`text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-xl ${
                          ...
                          {isCompleted ? "Aplicada (+2,5 mg)" : "Pendente"}
                        </span>
                      </div>
                    </motion.div>
                  );
